...
form.addEventListener('submit', (e) => {
    ...
    if (number.value === "") {
       document.getElementById('error-ph').innerHTML = "<p style='color:red;text-align:center;'>Enter number</p>";
        isFormValid = false;

    } else if (!/^\d+$/.test(number.value)) {
        document.getElementById('error-ph').innerHTML = "<p style='color:red;text-align:center;'>Enter a valid number</p>";
        isFormValid = false;
    }else {
        document.getElementById("error-ph").innerHTML = "";
    }
